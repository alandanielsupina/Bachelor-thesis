<x-app-layout>
    ...
    <div class="mt-10 flex flex-col items-center">
        <div class="w-full sm:max-w-md">
            ...
            <form id="bo-users-create" class="mb-10" method="post" action="{{ route('bo.users.store') }}">
                @csrf
                <!-- Name -->
                <div>
                ...
                <div class="flex mr-5 sm:mr-0 items-center justify-end mt-4">
                    {{-- <a onclick="document.getElementById('bo-users-create').submit()"
                        class="cursor-pointer group relative inline-block focus:outline-none focus:ring">
                        <span
                            class="absolute inset-0 translate-x-1.5 translate-y-1.5 bg-sky-400 transition-transform group-hover:translate-x-0 group-hover:translate-y-0"></span>
