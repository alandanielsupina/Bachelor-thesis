<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Upravenie služby {{ $service->name }} podniku {{ $selectedCompany->name }}
        </h2>
    </x-slot>
    ...
    <div class="mt-10 flex flex-col items-center">
        <div class="w-full sm:max-w-md">
            ...
            <form id="bo-services-update" class="mb-10" method="post"
                action="{{ route('bo.services.update', $service->id) }}">
                @csrf
                @method('put')

                <div>
                    <label for="name" class="text-lg font-bold mb-2">Názov</label>
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$service->name"
                        autofocus />
                ...
                <div class="mt-4">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input id="price" type="number" step="0.01" placeholder="0.00" name="price" value="{{ $service->price }}"
                ...
                <div class="mt-4">
                    ...
                    <input id="length" type="number" min="0" placeholder="0" value="{{ $service->length }}"
                        oninput="this.value = 
